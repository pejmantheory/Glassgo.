...
import homeStyles from '../styles/Home.module.css'; // Import Home.module.css with a unique name
import footerStyles from '../styles/Footer.module.css'; // Import Footer.module.css with a unique name
